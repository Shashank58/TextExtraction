...
public class ScrollView {
  ...
  private static java.util.ArrayList<SVWindow> windows;  // The id to SVWindow map.
  private static java.util.regex.Pattern intPattern;        // For checking integer arguments.
  private static java.util.regex.Pattern floatPattern;     // For checking float arguments.
  ...
  public static String receiveMessage() throws java.io.IOException {
    return in.readLine();
  }
  ...
  private static void parseArguments(String argList,
                                     ...
                                     java.util.ArrayList<Float> floatList,
                                     java.util.ArrayList<String> stringList,
                                     java.util.ArrayList<Boolean> boolList) {
  ...
  private static void processInput(String inputLine) {
    ...
    if (inputLine.charAt(0) == 'w') {
      ...
      // Parse the args.
      java.util.ArrayList<Integer> intList = new java.util.ArrayList<Integer>(4);
      java.util.ArrayList<Float> floatList = new java.util.ArrayList<Float>(2);
      java.util.ArrayList<String> stringList = new java.util.ArrayList<String>(4);
      java.util.ArrayList<Boolean> boolList = new java.util.ArrayList<Boolean>(3);
  ...
  public static void main(String[] args) {
    ...
    windows = new java.util.ArrayList<SVWindow>(100);
    intPattern = java.util.regex.Pattern.compile("[0-9-][0-9]*");
    floatPattern = java.util.regex.Pattern.compile("[0-9-][0-9]*\\.[0-9]*");
    ...
    try {
      ...
      // Setup the streams
      out = new java.io.PrintStream(socket.getOutputStream(), true);
      in =
