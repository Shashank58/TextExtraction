...
abstract class SVAbstractMenuItem {
   ...
   */
  SVAbstractMenuItem(int id, String name, javax.swing.JMenuItem jmi) {
    this.mi = jmi;
    this.name = name;
    this.id = id;
  }
  ...
  public void add(com.google.scrollview.ui.SVAbstractMenuItem mli) { }

  /** Adds a child menu to the submenu (or root node). */
  public void add(javax.swing.JMenu jli) { }
