...
public class SVPopupMenu implements java.awt.event.ActionListener {
  /** The root entry to add items to. */
  private javax.swing.JPopupMenu root;
  /** Contains a map of item name to its actual entry. */
  private java.util.HashMap<String, SVAbstractMenuItem> items;
  ...
  SVPopupMenu(SVWindow sv) {
    root = new javax.swing.JPopupMenu();
    svWindow = sv;
    items = new java.util.HashMap<String, SVAbstractMenuItem>();
  }
  ...
  public void add(String parent, String name, int id) {
    ...
    if (parent.equals("")) {
      javax.swing.JMenu jli = new javax.swing.JMenu(name);
