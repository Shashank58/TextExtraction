 ...
 */
public class SVWindow extends javax.swing.JFrame {
  /**
  ...
  java.awt.BasicStroke stroke = new java.awt.BasicStroke(0.5f);
  ...
  public void brush(int red, int green, int blue, int alpha) {
    ...
    if (alpha == 0) {
      ...
      currentBrushColor = new java.awt.Color(red, green, blue, alpha);
    }
  }
  ...
  public SVWindow(String name, int hash, int posX, int posY, int sizeX,
    ...
    this.currentPenColor = java.awt.Color.BLACK;
    this.currentBrushColor = java.awt.Color.BLACK;
    this.currentFont = new java.awt.Font("Times New Roman", java.awt.Font.PLAIN, 12);
  ...
  public void addMessageBox() {
    if (ta == null) {
      ...
      getContentPane().add(ta, java.awt.BorderLayout.SOUTH);
    }
  ...
  public void setStrokeWidth(float width) {
    ...
    stroke = new java.awt.BasicStroke(width);
  }
      ...
      for (int j = 0; j < allfonts.length; j++) {
        if (allfonts[j].canDisplay(chars[unreadableCharAt])) {
          java.awt.Font tempFont =
              new java.awt.Font(allfonts[j].getFontName(), currentFont.getStyle(),
                  currentFont.getSize());
          pt.setFont(tempFont);
          break;
        }
  ...
  public void pen(int red, int green, int blue, int alpha) {
    currentPenColor = new java.awt.Color(red, green, blue, alpha);
  }
  ...
  public void textAttributes(String font, int pixelSize, boolean bold,
    ...
    currentFont = new java.awt.Font(font, style, pixelSize);
  }
  ...
  public void zoomRectangle(int x1, int y1, int x2, int y2) {
    if (x2 > x1 && y2 > y1) {
      ...
      lc.animateViewToPanToBounds(new java.awt.Rectangle(x1 - hmargin, y1 - hmargin,
                                                2 * wmargin + width,
                                                2 * hmargin + height), 0);
    }
  }
  ...
  private static String convertIntegerStringToUnicodeString(String input) {
    ...
    java.util.regex.Pattern numbers = java.util.regex.Pattern.compile("0x[0-9a-fA-F]{4}");
    java.util.regex.Matcher matcher = numbers.matcher(sb);
  ...
  public void showInputDialog(String msg, String def, int id,
    ...
    String tmp =
        (String) javax.swing.JOptionPane.showInputDialog(this, msg, "",
            javax.swing.JOptionPane.QUESTION_MESSAGE, null, null, def);
  ...
  public void showYesNoDialog(String msg) {
    ...
    int res =
        javax.swing.JOptionPane.showOptionDialog(this, msg, "", javax.swing.JOptionPane.YES_NO_OPTION,
