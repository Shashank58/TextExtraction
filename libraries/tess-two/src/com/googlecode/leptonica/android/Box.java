...
public class Box {
    ...
    private static final String TAG = com.googlecode.leptonica.android.Box.class.getSimpleName();
    ...
    public Rect getRect() {
        ...
        int left = geometry[com.googlecode.leptonica.android.Box.INDEX_X];
        int top = geometry[com.googlecode.leptonica.android.Box.INDEX_Y];
        int right = left + geometry[com.googlecode.leptonica.android.Box.INDEX_W];
        int bottom = top + geometry[com.googlecode.leptonica.android.Box.INDEX_H];
