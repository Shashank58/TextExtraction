...
public class Pix {
     ...
     */
    @Override
    public com.googlecode.leptonica.android.Pix clone() {
        if (mRecycled)
            throw new IllegalStateException();
        ...
        return new com.googlecode.leptonica.android.Pix(nativePix);
    }
     ...
     */
    public static com.googlecode.leptonica.android.Pix createFromPix(byte[] pixData, int width, int height, int depth) {
