...
public class Pixa implements Iterable<Pix> {
    ...
    private static final String TAG = com.googlecode.leptonica.android.Pixa.class.getSimpleName();
     ...
     */
    public static com.googlecode.leptonica.android.Pixa createPixa(int size) {
     ...
     * @return a new Pixa or <code>null</code> on error
     */
    public static com.googlecode.leptonica.android.Pixa createPixa(int size, int width, int height) {
        ...
        return new com.googlecode.leptonica.android.Pixa(nativePixa, width, height);
    }
     ...
     */
    public com.googlecode.leptonica.android.Pixa copy() {
        if (mRecycled)
            throw new IllegalStateException();
        ...
        return new com.googlecode.leptonica.android.Pixa(nativePixa, mWidth, mHeight);
    }
     ...
     */
    public com.googlecode.leptonica.android.Pixa sort(int field, int order) {
        if (mRecycled)
            throw new IllegalStateException();
     ...
     */
    public boolean join(com.googlecode.leptonica.android.Pixa otherPixa) {
        if (mRecycled)
            throw new IllegalStateException();
     ...
     */
    public java.util.ArrayList<Rect> getBoxRects() {
        if (mRecycled)
            throw new IllegalStateException();

        final int pixaCount = nativeGetCount(mNativePixa);
        final int[] buffer = new int[4];
        final java.util.ArrayList<Rect> rects = new java.util.ArrayList<Rect>(pixaCount);
     ...
     * @return <code>true</code> on success
     */
    public boolean writeToFileRandomCmap(java.io.File file) {
        if (mRecycled)
            throw new IllegalStateException();
    ...
    public java.util.Iterator<Pix> iterator() {
        return new com.googlecode.leptonica.android.Pixa.PixIterator();
    }

    private class PixIterator implements java.util.Iterator<Pix> {
        private int mIndex;
