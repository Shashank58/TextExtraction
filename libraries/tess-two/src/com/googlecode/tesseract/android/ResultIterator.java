...
public class ResultIterator extends PageIterator {
     ...
     */
    public java.util.List<Pair<String, Double>> getChoicesAndConfidence(int level) {
        // Get the native choices
        String[] nativeChoices = nativeGetChoices(mNativeResultIterator, level);

        // Create the output list
        java.util.ArrayList<Pair<String, Double>> pairedResults = new java.util.ArrayList<Pair<String, Double>>();
