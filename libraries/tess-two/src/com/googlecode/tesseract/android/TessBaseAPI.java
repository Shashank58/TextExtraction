...
public class TessBaseAPI {
    ...
    private com.googlecode.tesseract.android.TessBaseAPI.ProgressNotifier progressNotifier;
    ...
    public interface ProgressNotifier {
        void onProgressValues(com.googlecode.tesseract.android.TessBaseAPI.ProgressValues progressValues);
    }
    ...
    public boolean init(String datapath, String language, int ocrEngineMode) {
        ...
        if (!datapath.endsWith(java.io.File.separator))
            datapath += java.io.File.separator;

        java.io.File datapathFile = new java.io.File(datapath);
        if (!datapathFile.exists())
            throw new IllegalArgumentException("Data path does not exist!");

        java.io.File tessdata = new java.io.File(datapath + "tessdata");
        ...
        if (ocrEngineMode != OEM_CUBE_ONLY) {
            for (String languageCode : language.split("\\+")) {
                if (!languageCode.startsWith("~")) {
                    java.io.File datafile = new java.io.File(tessdata + java.io.File.separator +
    ...
    protected void onProgressValues(final int percent, final int left,
        ...
        if (progressNotifier != null) {
            ...
            com.googlecode.tesseract.android.TessBaseAPI.ProgressValues pv = new com.googlecode.tesseract.android.TessBaseAPI.ProgressValues(percent, wordRect, textRect);
